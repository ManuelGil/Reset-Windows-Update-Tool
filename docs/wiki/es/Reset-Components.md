Si continuamente tiene un problema de fallos de Windows Update, entonces es el momento de restablecer los Componentes de Windows Update a su valor predeterminado.
